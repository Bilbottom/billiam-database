{% call dbt_unit_testing.test(
  ...
  {% call dbt_unit_testing.expect() %}
    group_id | group_description | project    | detail   | total_records | total_time | start_time            | end_time
    ...
    1        | 'Task only'       | 'BAU Task' | ''       | 4             | 60         | '2019-04-23 08:15:00' | '2019-04-23 09:05:00'
  {% endcall %}
{% endcall %}
