...
{% call dbt_unit_testing.test(
  ...
  {% call dbt_unit_testing.mock_ref("stg__daily_tracker", {"input_format": "csv"}) %}
    date_time,task,detail,interval,company
    '2019-04-23 08:15:00','BAU Task','Task 1',15,'TSB'
    '2019-04-23 08:30:00','BAU Task','Task 2',15,'TSB'
    '2019-04-23 08:45:00','BAU Task','Task 3',15,'TSB'
    '2019-04-23 09:05:00','BAU Task','Task 4',15,'TSB'
  {% endcall %}
